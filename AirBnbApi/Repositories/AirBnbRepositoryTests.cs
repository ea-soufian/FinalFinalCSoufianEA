...
namespace AirBnbApi.Repositories
{
    public class AirBnbRepositoryTests : IAirBnbRepository
    {
        ...
        public IEnumerable<Customer> GetAllCustomers()
        {
            ...
            {
                new Customer { Id = 1, Email = "test@mail.com", FirstName = "nas", LastName = "gool" },
                new Customer { Id = 2, Email = "test2@gmail.com", FirstName= "fed", LastName = "basi" }
            };
        }
        ...
        public IEnumerable<Landlord> GetAllLandlords()
        {
            ...
            {
                new Landlord {Id = 1, Age = 29, FirstName = "nas", LastName = "Doe" },
                new Landlord {Id = 2, Age = 35, FirstName = "fed", LastName = "basi" }
            };
        }
        ...
        {
            return new Landlord { Id = 1, Age = 29, FirstName = "nas", LastName = "Doe" };
        }
